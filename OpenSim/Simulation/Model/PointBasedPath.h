...
public:
    PointBasedPath();
    ~PointBasedPath() override = default;
    ...
    /** %Set the value of the color cache variable owned by this %PointBasedPath
    ...
    %PointBasedPath object in the given state. You can access this value any time
    ...
    or it will have the default color value chosen by %PointBasedPath.
    @see setDefaultColor() **/
    ...
    /** add in the equivalent body and generalized forces to be applied to the 
        multibody system resulting from a tension along the PointBasedPath
